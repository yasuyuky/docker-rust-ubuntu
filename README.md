...
```bash
docker pull ghcr.io/yasuyuky/rust-ubuntu:jammy-1.91.1
```

## Available Tags

- `latest` - Latest Rust on Ubuntu Focal (20.04)
- `<VERSION>` - Specific Rust version on Focal (e.g., `1.91.1`)
- `<DIST>-<VERSION>` - Specific distribution and version (e.g., `jammy-1.91.1`, `noble-1.91.1`)
