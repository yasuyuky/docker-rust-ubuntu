...
<!-- BEGIN AUTO-GENERATED VERSION USAGE -->
Or specify a distribution and version:

```bash
docker pull ghcr.io/yasuyuky/rust-ubuntu:jammy-1.94.0
```

## Available Tags

- `latest` - Latest Rust on Ubuntu Focal (20.04)
- `<VERSION>` - Specific Rust version on Focal (e.g., `1.94.0`)
- `<DIST>-<VERSION>` - Specific distribution and version (e.g., `jammy-1.94.0`, `noble-1.94.0`)
